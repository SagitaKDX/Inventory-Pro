...
urlpatterns = [
    ...
    path('inventory/<int:item_id>/<str:warehouse_id>/', views.manage_inventory, name='manage-inventory'),
]
...
warehouse_patterns = [
    ...
    path('warehouse/<str:pk>/', views.WarehouseDetailView.as_view(), name='warehouse-detail'),
    path('warehouse/<str:pk>/update/', views.WarehouseUpdateView.as_view(), name='warehouse-update'),
    path('warehouse/<str:warehouse_id>/set-current/', views.set_current_warehouse, name='set-current-warehouse'),
]

urlpatterns += warehouse_patterns
